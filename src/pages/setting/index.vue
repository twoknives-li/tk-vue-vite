  ...
  <div>
    <el-form class="p-12">
      <el-form-item label="主题色">
        ...
        <el-color-picker @change="changColor('topBar')" v-model="themeConfig.topBar" /> {{ themeConfig.topBar }}
      </el-form-item>
      <el-button type="primary" @click="changeTheme('')">关闭夜间模式</el-button>
      <el-button type="primary" @click="changeTheme('dark')">开启夜间模式</el-button>
    </el-form>
...
const changColor = (color)=>{
  console.log("changColor",color);
	...
	document.documentElement.style.setProperty(`--next-bg-${color}`, themeConfig.value[color]);
}
</script>
<style lang="scss">
.box{
